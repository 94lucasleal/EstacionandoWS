...
public class EstabelecimetoBD extends CrudBD<Estabelecimento> {
    ...
    public void inserirEstabelecimento(Estabelecimento bean) {
        ...
        try {
            ...
            System.out.println("3"+format.parse(bean.getEntrada_segunda()).getTime());
            ...
            pstm.setTimestamp(26, new java.sql.Timestamp(format.parse(bean.getEntrada_quinta()).getTime()));
            pstm.setTimestamp(27, new java.sql.Timestamp(format.parse(bean.getEntrada_sexta()).getTime()));
            pstm.setTimestamp(28, new java.sql.Timestamp(format.parse(bean.getEntrada_sabado()).getTime()));
            pstm.setTimestamp(29, new java.sql.Timestamp(format.parse(bean.getEntrada_domingo()).getTime()));
            pstm.setTimestamp(30, new java.sql.Timestamp(format.parse(bean.getSaida_segunda()).getTime()));
            pstm.setTimestamp(31, new java.sql.Timestamp(format.parse(bean.getSaida_terca()).getTime()));
            pstm.setTimestamp(32, new java.sql.Timestamp(format.parse(bean.getSaida_quarta()).getTime()));
            pstm.setTimestamp(33, new java.sql.Timestamp(format.parse(bean.getSaida_quinta()).getTime()));
            pstm.setTimestamp(34, new java.sql.Timestamp(format.parse(bean.getSaida_sexta()).getTime()));
            pstm.setTimestamp(35, new java.sql.Timestamp(format.parse(bean.getSaida_sabado()).getTime()));
            pstm.setTimestamp(36, new java.sql.Timestamp(format.parse(bean.getSaida_sabado()).getTime()));
            pstm.setTimestamp(37, new java.sql.Timestamp(format.parse(bean.getSaida_domingo()).getTime()));
