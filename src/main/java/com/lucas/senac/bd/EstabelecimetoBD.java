...
public class EstabelecimetoBD extends CrudBD<Estabelecimento> {
    ...
    public void inserirEstabelecimento(Estabelecimento bean) {
        ...
        try {
            ...
            java.sql.Time time = new java.sql.Time(36000);
            pstm.setTime(23, time);
            pstm.setTime(24, time);
            pstm.setTime(25, time);
            pstm.setTime(26, time);
            pstm.setTime(27, time);
            pstm.setTime(28, time);
            pstm.setTime(29, time);
            pstm.setTime(30, time);
            pstm.setTime(31, time);
            pstm.setTime(32, time);
            pstm.setTime(33, time);
