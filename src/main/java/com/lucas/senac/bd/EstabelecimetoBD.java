...
public class EstabelecimetoBD extends CrudBD<Estabelecimento> {
    ...
    public void inserirEstabelecimento(Estabelecimento bean) {
        ...
        try {
            ...
            pstm.setTime(36, new java.sql.Time(format.parse(bean.getSaida_sabado()).getTime()));
            pstm.setTime(37, new java.sql.Time(format.parse(bean.getSaida_domingo()).getTime()));
